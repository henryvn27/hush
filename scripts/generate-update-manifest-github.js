...
console.log(`GitHub Repository: henryvn27/hush`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/henryvn27/hush/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/henryvn27/hush/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/henryvn27/hush/releases/latest/download/latest.json`);
