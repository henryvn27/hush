...
| Idle control | Compact dark bar, hidden by default on new installs, contextual menu | Compact dark pill capped at 10.5rem, with generated Hush mark, status, shortcut hint, accessible menu, and one-hour snooze; native transparent always-on-top window is 176x48 | Prove persistence across close/relaunch, multiple displays, Spaces, and full-screen |
