...
- The Flow Bar is now intentionally small: the CSS control is capped at 9.5rem and the native window is 160x44, keeping it close to Wispr's low-interruption pill reference.
